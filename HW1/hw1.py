...
class Application:
    ...
    def drawStart(self):
        ...
        pygame.draw.rect(self.displaySurface, (0, 0, 255), (int(col * self.blockSizeX + self.blockSizeX/4), int(
            row * self.blockSizeY + self.blockSizeY/4), int(self.blockSizeX * 0.5), int(self.blockSizeY * 0.5)), 0)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', dest="search", type=str, default="bfs",
                        choices=["bfs", "astar_corner",
                                 "astar", "fast", "astar_multi"],
